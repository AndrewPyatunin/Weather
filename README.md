...
### Running the apps
Add **API_KEY**=*your_api_key* into local.properties file, this api_key could be obtained from *OpenWeatherMap.org*.
Also add **CLIENT_ID**=*your_Access Key* into local.properties, you can take it from *Unsplash.com/developers*, 
